...
import { IProcesso, type ITarefa } from '../../schema/InterfaceProcess';
...
const ViewProcessoTabs: React.FC = () => {
  ...
  const handleDeleteAssociados = (item: IProcesso) => {
            ...
            <BoxCard>
              ...
              */}
              ...
              <TabPanel value={tabIndex} index={4}>
                  <TabAssociados idProcesso={Number(id)} data={associados}  onDelete={handleDeleteAssociados}/>
              </TabPanel>
