...
const menuItems: IMenuItem[] = [
  ...
  { text: 'Minhas Tarefas', icon: <Assignment />, path: ROUTES_PATH.MyTasks, section: "user" },
  ...
  { text: 'Tarefas', icon: <Assignment />, profiles: [UserRoles.ADMINISTRATIVO], path: ROUTES_PATH.Tasks, section: "admin" },
