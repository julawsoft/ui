...
export function CardDocumentEmployee({ icon, solicitacao, status, statusText, created, duracao, attach, isApproved, note, handleEdit, handleDelete, handleView, handleViewAttach, handleDownloadAttach }: ICardYourRequest) {
            ...
            <Box boxShadow={'md'} border={'1px solid #d3d3d3'}>
                ...
                >
                    ...
                    <Flex gap={1} fontSize={12}>
                        <Text fontWeight={'semibold'}>N.º Documento: </Text>
                        <Text> {note} </Text>
                    </Flex>
                            ...
                            <>
                                {
                                    isAskAction ?
                                        (
                                            <>
                                                <Box mt={2} p={1} bgColor={"#323232"} minH={'20px'} width={'auto'}>
                                        ...
                                        (
                                            <>
                                                <Box mt={2} p={1} bgColor={"#f2f2f2"} minH={'20px'} width={'auto'}>
