  ...
  <div class="col-xs-12">
    <div class="card">
      ...
      <ul class="nav nav-underline">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#dashoboardMeusProcessos">Meus Processos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#dashoboardMinhaAgenda">Minha Agenda</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#dashoboardMinhasTarefas">Minhas Tarefas</a>
        </li>
      </ul>
