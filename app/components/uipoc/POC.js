        ...
        <!--
            renderIf:
                - Is to be used whe component shouldn't render in case its 
                  value is not true;
                - This should be used especially when it comes to security purspose
                  where the used should not see certain part of the UI in case he does
                  not have the proper permission
                  E.g. (renderIf)="AppTemplate.get().getStorageValue('persmissions').canSeeGrid"
            showIf:
